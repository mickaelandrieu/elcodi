...
class CarrierResolver
{
     ...
     */
    protected $carrierResolverType;

    /**
     * Construct method
     *
     * @param CurrencyConverter $currencyConverter   Currency Converter
     * @param integer           $carrierResolverType Carrier Resolver Type
     */
        ...
        $carrierResolverType)
    {
        ...
        $this->carrierResolverType = $carrierResolverType;
    }
    ...
    public function resolveCarrierRanges(array $carrierRanges)
    {
        ...
        switch ($this->carrierResolverType) {

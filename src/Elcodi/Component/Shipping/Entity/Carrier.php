...
class Carrier implements CarrierInterface
{
     ...
     * Sets MaximumWeight
     *
     * @param int $maximumWeight MaximumWeight
     *
     * @return $this Self object
     */
    ...
    /**
     * Get OutOfRangesAction
     *
     * @return int OutOfRangesAction
     */
    public function getOutOfRangesAction()
    {
        return $this->outOfRangesAction;
    }

    /**
     * Sets OutOfRangesAction
     *
     * @param int $outOfRangesAction OutOfRangesAction
     *
     * @return $this Self object
     */
    public function setOutOfRangesAction($outOfRangesAction)
    {
        $this->outOfRangesAction = $outOfRangesAction;
